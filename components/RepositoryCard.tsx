...
const RepositoryCard = () => {
  ...
  return (
    <div className="block md:hidden mt-4">
      {repositories?.map((repository: any) => <div className="border rounded-lg border-gray-400/50 p-2 mb-2 mx-1.5">
        <h1> <span className="repCardTitle">ID: </span> {repository.id}</h1>
